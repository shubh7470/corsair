  ...
  return (
    <header className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4 w-full">
      <div className="flex w-full max-w-5xl items-center justify-between rounded-full border border-white/20 bg-white/10 backdrop-blur-md px-4 py-3 shadow-sm">
        ...
        {/* Right: Sign in with Google */}
        <div className="flex items-center pr-1">
          <button className="flex items-center justify-center gap-2 rounded-full bg-black px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
            <svg
              className="h-4 w-4"
              aria-hidden="true"
              focusable="false"
